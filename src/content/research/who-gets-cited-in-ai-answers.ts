...
export const methodology = {
  ...
  lead: 'The instrument is a first-party probe that calls the DataForSEO AI Optimization API, one question at a time, per engine, and records the URLs each engine cited. It is the same instrument Hendricks points at a client engagement, and it produced this run for a different study before this one was written.',
  items: [
    {
      number: '01',
...
export const corrections = {
  eyebrow: 'Corrections',
  title: 'No corrections to this page yet, and how the first one gets made',
  body: [
