...
describe('Breadcrumbs', () => {
  it('names the trail, marks the current page and boxes every link', () => {
    ...
    expect(nav).toHaveClass('crumbs')
    expect(nav.querySelector('ol')).not.toBeNull()
    expect(screen.getByText('Selection Intelligence')).toHaveAttribute('aria-current', 'page')
    // The slash between items is generated by `.crumbs li + li::before`, so no
    // separator element is ever announced.
    expect(nav.textContent).toBe('HomeSolutionsSelection Intelligence')
