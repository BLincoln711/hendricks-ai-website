    ...
    <div className="min-h-screen bg-slate-950 text-slate-50">
      ...
      <section className="relative max-w-6xl mx-auto px-4 pt-16 pb-10">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center rounded-full border border-slate-700/70 bg-slate-900/60 px-6 py-2.5 text-xs font-semibold text-slate-200 hover:border-sky-400/70 hover:text-sky-300 transition"
          >
        ...
        <div className="mt-10 rounded-2xl border border-slate-800 bg-slate-900/80 p-6 shadow-[0_0_40px_rgba(15,23,42,0.9)]">
          ...
          <p className="mt-3 text-xs md:text-sm text-slate-300 max-w-3xl">
      ...
      <section className="relative max-w-6xl mx-auto px-4 pb-16 space-y-8">
        ...
        <section id="foundation" className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 md:p-7">
          <p className="text-[11px] font-semibold tracking-[0.24em] uppercase text-sky-300">
            Tier 1
          </p>
          ...
          <p className="mt-4 text-xs md:text-sm text-slate-200 max-w-3xl">
          ...
          <div className="mt-6">
            <Link
              ...
              className="inline-flex items-center text-xs font-semibold text-sky-400 hover:text-sky-300 transition"
            >
        ...
        <section className="mt-10 mb-6 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 md:p-7">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center rounded-full bg-gradient-to-r from-sky-500 via-blue-500 to-violet-500 px-6 py-2.5 text-xs font-semibold text-slate-950 hover:from-sky-400 hover:via-blue-400 hover:to-violet-400 transition"
            >
              Book Visibility Consultation
            </Link>
            <Link
              href="/insights"
              className="inline-flex items-center rounded-full border border-slate-700 px-6 py-2.5 text-xs font-semibold text-slate-200 hover:border-sky-400 hover:text-sky-300 transition"
            >
              Explore Insights
            </Link>
          </div>
