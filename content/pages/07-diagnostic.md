...
**Description:** A fixed-scope engagement that maps valuable search demand, measures brand consideration across Google and AI-mediated search, identifies selection gaps, and produces a 90-day roadmap.

**H1:** Find Your Commercial Selection Gap.

## Hero

**Eyebrow:** THE ENTRY ENGAGEMENT

# Find Your Commercial Selection Gap.
...
The final fixed fee is based on:
...
Do not discount the Diagnostic into a commodity audit.

## Good fit

The Diagnostic is designed for organizations that:
...
It is not designed for organizations seeking:
...
# Leave with clarity about what should be built first.

Form fields are defined in `docs/07-ANALYTICS-AND-LEAD-CAPTURE.md`.

**Submit button:** Apply for a Search Intelligence Diagnostic

**Support text:** Diagnostic engagements typically begin at $15,000 and are designed for organizations prepared to provide relevant data, implement approved changes, and connect the program to a defined business outcome.

**Confirmation message:** Thank you. Your request is being reviewed for fit. Qualified inquiries receive a direct response with the appropriate next step. Hendricks does not place every applicant into an automated sales sequence.
