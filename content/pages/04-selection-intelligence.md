...
**Question answered:** What happens under standardized conditions?
...
**Question answered:** Which customer profiles cause the brand to enter or leave consideration?

### Journey context

Multi-step research and comparison journeys that become more specific over time.

**Question answered:** Does the brand survive as the customer moves from exploration to a shortlist?

### Time and platform panel

Repeated tests across relevant search and AI experiences, dates, models, and locations.

**Question answered:** How stable is the observed outcome?

## What Hendricks measures
...
# Hendricks does not claim to inspect hidden model reasoning.
...
# Six questions to settle before commissioning a baseline.

### How do you account for personalization?
...
### How many prompts or contexts are required?
...
### Can one brand be strong for one cohort and weak for another?
...
### How frequently should the baseline be repeated?
