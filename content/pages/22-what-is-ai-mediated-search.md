...
**Table caption:** Named AI-mediated search surfaces and whether Hendricks observes each one.
...
**Table caption:** Traditional search results compared with AI-mediated search, by dimension.
...
**Applied in:** the Selection Intelligence solution, the measurement methodology
